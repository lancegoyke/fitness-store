# Generated by Django 3.2.11 on 2022-08-27 15:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0016_auto_20220827_1504'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aggregate_usage', models.CharField(choices=[('None', '---------'), ('sum', 'All usage during period'), ('last_during_period', 'Last usage record reported within a period'), ('last_ever', 'Last usage record ever (across period bounds)'), ('max', 'Maximum reported usage during a period')], default=None, help_text='Specifices a usage aggregation strategy for prices of `usage_type=metered`', max_length=18, null=True)),
                ('interval', models.CharField(choices=[('None', '---------'), ('once', 'Once'), ('day', 'Day'), ('week', 'Week'), ('month', 'Month'), ('year', 'Year')], default=None, max_length=5, null=True)),
                ...
                ('usage_type', models.CharField(choices=[('None', '---------'), ('metered', '`metered`: aggregates the total usage based on usage records'), ('licensed', '`licensed`: automatically bills the `quantity` set when adding it to a subscription (default)')], default=None, max_length=8, null=True)),
                ...
                ('tiers_mode', models.CharField(choices=[('None', '---------'), ('graduated', '`graduated`: pricing changes as the quantity grows'), ('volume', '`volume`: the maximum quantity within a period determines the per unit price')], default=None, max_length=9, null=True)),
            ],
